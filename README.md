...
**场景：** 本库已内置高性能的文件同步、目录遍历、索引维护等底层能力。开发者可在此基础上构建多种上层应用，包括但不限于：本地文件搜索、Web 在线搜索聚合、家庭影院媒体中心、AI 搜索助手、自动化文件整理等场景。
...
| 特性 | 说明 |
|------|------|
| 🚀 极致性能 | 采用并行计算架构，充分利用多核 CPU，实现毫秒级搜索.1200万文件0.006秒搜索完成(CPU E5-2690 v3 * 2) |
