...
cl /EHsc /O2 /GL /utf-8 /DUNICODE /D_UNICODE main.cpp main.res /Fe:XunJieSo.exe /link xunjieso.lib comctl32.lib user32.lib gdi32.lib shell32.lib ole32.lib advapi32.lib gdiplus.lib /SUBSYSTEM:WINDOWS /LTCG /MANIFEST:EMBED
